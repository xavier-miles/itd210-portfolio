                ...
                if (propertiesReplacements.get(node.property) &&
                    ...
                    context.report({
                        ...
                        data: {
                            ...
                            replacement: propertiesReplacements.get(node.property),
                        },
                    });
                }
                if (propertyValuesReplacements.get(node.property) &&
                    node.value.type === "Value" &&
                    node.value.children[0].type === "Identifier") {
                    const nodeValue = node.value.children[0].name;
                    if (propertyValuesReplacements.get(node.property)[nodeValue]) {
                        const replacement = propertyValuesReplacements.get(node.property)[nodeValue];
                        if (replacement) {
                            context.report({
