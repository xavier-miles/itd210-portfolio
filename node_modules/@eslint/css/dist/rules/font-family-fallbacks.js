 ...
 * @private
 */
function reportFontWithoutFallbacksInFontProperty(fontPropertyValues, context, node) {
            ...
            "Rule > Block > Declaration[property='font'] > Value"(node) {
                ...
                if (valueArr.length === 1) {
                    ...
                    if (firstValue.type === "Function" &&
                        ...
                        reportFontWithoutFallbacksInFontProperty(variableValue, context, node);
                    }
                }
                else {
                    const isUsingVariable = valueArr.some(child => isVarFunction(child));
                    if (isUsingVariable) {
                        ...
                        if (fontPropertyValues) {
                            reportFontWithoutFallbacksInFontProperty(fontPropertyValues, context, node);
                        }
                    }
                }
            },
